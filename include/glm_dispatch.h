...
struct GLMDispatchTable
{
    ...
    void (*tex_image1D)(GLMContext ctx, GLenum target, GLint level, GLint internalformat, GLsizei width, GLint border,
                        GLenum format, GLenum type, const void *pixels);
    void (*tex_image2D)(GLMContext ctx, GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height,
    ...
    void (*read_pixels)(GLMContext ctx, GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type,
                        void *pixels);
    ...
    void (*bitmap)(GLMContext ctx, GLsizei width, GLsizei height, GLfloat xorig, GLfloat yorig, GLfloat xmove,
    ...
    void (*map1d)(GLMContext ctx, GLenum target, GLdouble u1, GLdouble u2, GLint stride, GLint order,
                  const GLdouble *points);
    void (*map1f)(GLMContext ctx, GLenum target, GLfloat u1, GLfloat u2, GLint stride, GLint order,
                  const GLfloat *points);
    void (*map2d)(GLMContext ctx, GLenum target, GLdouble u1, GLdouble u2, GLint ustride, GLint uorder, GLdouble v1,
                  GLdouble v2, GLint vstride, GLint vorder, const GLdouble *points);
    void (*map2f)(GLMContext ctx, GLenum target, GLfloat u1, GLfloat u2, GLint ustride, GLint uorder, GLfloat v1,
    ...
    void (*frustum)(GLMContext ctx, GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble zNear,
                    GLdouble zFar);
    ...
    void (*ortho)(GLMContext ctx, GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble zNear,
                  GLdouble zFar);
    ...
    void (*copy_tex_image1D)(GLMContext ctx, GLenum target, GLint level, GLenum internalformat, GLint x, GLint y,
                             GLsizei width, GLint border);
    void (*copy_tex_image2D)(GLMContext ctx, GLenum target, GLint level, GLenum internalformat, GLint x, GLint y,
                             GLsizei width, GLsizei height, GLint border);
    void (*copy_tex_sub_image1D)(GLMContext ctx, GLenum target, GLint level, GLint xoffset, GLint x, GLint y,
                                 GLsizei width);
    void (*copy_tex_sub_image2D)(GLMContext ctx, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint x,
                                 GLint y, GLsizei width, GLsizei height);
    void (*tex_sub_image1D)(GLMContext ctx, GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format,
                            GLenum type, const void *pixels);
    void (*tex_sub_image2D)(GLMContext ctx, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width,
    ...
    void (*draw_range_elements)(GLMContext ctx, GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type,
                                const void *indices);
    void (*tex_image3D)(GLMContext ctx, GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height,
                        GLsizei depth, GLint border, GLenum format, GLenum type, const void *pixels);
    void (*tex_sub_image3D)(GLMContext ctx, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset,
                            GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type,
                            const void *pixels);
    void (*copy_tex_sub_image3D)(GLMContext ctx, GLenum target, GLint level, GLint xoffset, GLint yoffset,
    ...
    void (*compressed_tex_image3D)(GLMContext ctx, GLenum target, GLint level, GLenum internalformat, GLsizei width,
                                   GLsizei height, GLsizei depth, GLint border, GLsizei imageSize, const void *data);
    void (*compressed_tex_image2D)(GLMContext ctx, GLenum target, GLint level, GLenum internalformat, GLsizei width,
                                   GLsizei height, GLint border, GLsizei imageSize, const void *data);
    void (*compressed_tex_image1D)(GLMContext ctx, GLenum target, GLint level, GLenum internalformat, GLsizei width,
                                   GLint border, GLsizei imageSize, const void *data);
    void (*compressed_tex_sub_image3D)(GLMContext ctx, GLenum target, GLint level, GLint xoffset, GLint yoffset,
                                       GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format,
                                       GLsizei imageSize, const void *data);
    void (*compressed_tex_sub_image2D)(GLMContext ctx, GLenum target, GLint level, GLint xoffset, GLint yoffset,
                                       GLsizei width, GLsizei height, GLenum format, GLsizei imageSize,
                                       const void *data);
    void (*compressed_tex_sub_image1D)(GLMContext ctx, GLenum target, GLint level, GLint xoffset, GLsizei width,
    ...
    void (*blend_func_separate)(GLMContext ctx, GLenum sfactorRGB, GLenum dfactorRGB, GLenum sfactorAlpha,
                                GLenum dfactorAlpha);
    void (*multi_draw_arrays)(GLMContext ctx, GLenum mode, const GLint *first, const GLsizei *count, GLsizei drawcount);
    void (*multi_draw_elements)(GLMContext ctx, GLenum mode, const GLsizei *count, GLenum type,
    ...
    void (*get_active_attrib)(GLMContext ctx, GLuint program, GLuint index, GLsizei bufSize, GLsizei *length,
                              GLint *size, GLenum *type, GLchar *name);
    void (*get_active_uniform)(GLMContext ctx, GLuint program, GLuint index, GLsizei bufSize, GLsizei *length,
                               GLint *size, GLenum *type, GLchar *name);
    ...
    void (*shader_source)(GLMContext ctx, GLuint shader, GLsizei count, const GLchar *const *string,
                          const GLint *length);
    ...
    void (*vertex_attrib_pointer)(GLMContext ctx, GLuint index, GLint size, GLenum type, GLboolean normalized,
                                  GLsizei stride, const void *pointer);
    void (*uniform_matrix2x3fv)(GLMContext ctx, GLint location, GLsizei count, GLboolean transpose,
                                const GLfloat *value);
    void (*uniform_matrix3x2fv)(GLMContext ctx, GLint location, GLsizei count, GLboolean transpose,
                                const GLfloat *value);
    void (*uniform_matrix2x4fv)(GLMContext ctx, GLint location, GLsizei count, GLboolean transpose,
                                const GLfloat *value);
    void (*uniform_matrix4x2fv)(GLMContext ctx, GLint location, GLsizei count, GLboolean transpose,
                                const GLfloat *value);
    void (*uniform_matrix3x4fv)(GLMContext ctx, GLint location, GLsizei count, GLboolean transpose,
                                const GLfloat *value);
    void (*uniform_matrix4x3fv)(GLMContext ctx, GLint location, GLsizei count, GLboolean transpose,
                                const GLfloat *value);
    ...
    void (*bind_buffer_range)(GLMContext ctx, GLenum target, GLuint index, GLuint buffer, GLintptr offset,
                              GLsizeiptr size);
    void (*bind_buffer_base)(GLMContext ctx, GLenum target, GLuint index, GLuint buffer);
    void (*transform_feedback_varyings)(GLMContext ctx, GLuint program, GLsizei count, const GLchar *const *varyings,
                                        GLenum bufferMode);
    void (*get_transform_feedback_varying)(GLMContext ctx, GLuint program, GLuint index, GLsizei bufSize,
    ...
    void (*vertex_attrib_i_pointer)(GLMContext ctx, GLuint index, GLint size, GLenum type, GLsizei stride,
                                    const void *pointer);
    ...
    void (*framebuffer_texture1D)(GLMContext ctx, GLenum target, GLenum attachment, GLenum textarget, GLuint texture,
                                  GLint level);
    void (*framebuffer_texture2D)(GLMContext ctx, GLenum target, GLenum attachment, GLenum textarget, GLuint texture,
                                  GLint level);
    void (*framebuffer_texture3D)(GLMContext ctx, GLenum target, GLenum attachment, GLenum textarget, GLuint texture,
                                  GLint level, GLint zoffset);
    void (*framebuffer_renderbuffer)(GLMContext ctx, GLenum target, GLenum attachment, GLenum renderbuffertarget,
                                     GLuint renderbuffer);
    void (*get_framebuffer_attachment_parameteriv)(GLMContext ctx, GLenum target, GLenum attachment, GLenum pname,
                                                   GLint *params);
    void (*generate_mipmap)(GLMContext ctx, GLenum target);
    void (*blit_framebuffer)(GLMContext ctx, GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0,
                             GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter);
    void (*renderbuffer_storage_multisample)(GLMContext ctx, GLenum target, GLsizei samples, GLenum internalformat,
                                             GLsizei width, GLsizei height);
    void (*framebuffer_texture_layer)(GLMContext ctx, GLenum target, GLenum attachment, GLuint texture, GLint level,
                                      GLint layer);
    ...
    void (*draw_elements_instanced)(GLMContext ctx, GLenum mode, GLsizei count, GLenum type, const void *indices,
    ...
    void (*copy_buffer_sub_data)(GLMContext ctx, GLenum readTarget, GLenum writeTarget, GLintptr readOffset,
                                 GLintptr writeOffset, GLsizeiptr size);
    void (*get_uniform_indices)(GLMContext ctx, GLuint program, GLsizei uniformCount, const GLchar *const *uniformNames,
                                GLuint *uniformIndices);
    void (*get_active_uniformsiv)(GLMContext ctx, GLuint program, GLsizei uniformCount, const GLuint *uniformIndices,
                                  GLenum pname, GLint *params);
    void (*get_active_uniform_name)(GLMContext ctx, GLuint program, GLuint uniformIndex, GLsizei bufSize,
    ...
    void (*get_active_uniform_blockiv)(GLMContext ctx, GLuint program, GLuint uniformBlockIndex, GLenum pname,
                                       GLint *params);
    void (*get_active_uniform_block_name)(GLMContext ctx, GLuint program, GLuint uniformBlockIndex, GLsizei bufSize,
    ...
    void (*draw_elements_base_vertex)(GLMContext ctx, GLenum mode, GLsizei count, GLenum type, const void *indices,
                                      GLint basevertex);
    void (*draw_range_elements_base_vertex)(GLMContext ctx, GLenum mode, GLuint start, GLuint end, GLsizei count,
                                            GLenum type, const void *indices, GLint basevertex);
    void (*draw_elements_instanced_base_vertex)(GLMContext ctx, GLenum mode, GLsizei count, GLenum type,
                                                const void *indices, GLsizei instancecount, GLint basevertex);
    void (*multi_draw_elements_base_vertex)(GLMContext ctx, GLenum mode, const GLsizei *count, GLenum type,
    ...
    void (*tex_image2_d_multisample)(GLMContext ctx, GLenum target, GLsizei samples, GLenum internalformat,
                                     GLsizei width, GLsizei height, GLboolean fixedsamplelocations);
    void (*tex_image3_d_multisample)(GLMContext ctx, GLenum target, GLsizei samples, GLenum internalformat,
    ...
    void (*bind_frag_data_location_indexed)(GLMContext ctx, GLuint program, GLuint colorNumber, GLuint index,
                                            const GLchar *name);
    ...
    void (*blend_func_separatei)(GLMContext ctx, GLuint buf, GLenum srcRGB, GLenum dstRGB, GLenum srcAlpha,
                                 GLenum dstAlpha);
    ...
    void (*uniform_matrix2dv)(GLMContext ctx, GLint location, GLsizei count, GLboolean transpose,
                              const GLdouble *value);
    void (*uniform_matrix3dv)(GLMContext ctx, GLint location, GLsizei count, GLboolean transpose,
                              const GLdouble *value);
    void (*uniform_matrix4dv)(GLMContext ctx, GLint location, GLsizei count, GLboolean transpose,
                              const GLdouble *value);
    void (*uniform_matrix2x3dv)(GLMContext ctx, GLint location, GLsizei count, GLboolean transpose,
                                const GLdouble *value);
    void (*uniform_matrix2x4dv)(GLMContext ctx, GLint location, GLsizei count, GLboolean transpose,
                                const GLdouble *value);
    void (*uniform_matrix3x2dv)(GLMContext ctx, GLint location, GLsizei count, GLboolean transpose,
                                const GLdouble *value);
    void (*uniform_matrix3x4dv)(GLMContext ctx, GLint location, GLsizei count, GLboolean transpose,
                                const GLdouble *value);
    void (*uniform_matrix4x2dv)(GLMContext ctx, GLint location, GLsizei count, GLboolean transpose,
                                const GLdouble *value);
    void (*uniform_matrix4x3dv)(GLMContext ctx, GLint location, GLsizei count, GLboolean transpose,
                                const GLdouble *value);
    ...
    void (*get_active_subroutine_uniformiv)(GLMContext ctx, GLuint program, GLenum shadertype, GLuint index,
                                            GLenum pname, GLint *values);
    void (*get_active_subroutine_uniform_name)(GLMContext ctx, GLuint program, GLenum shadertype, GLuint index,
                                               GLsizei bufSize, GLsizei *length, GLchar *name);
    void (*get_active_subroutine_name)(GLMContext ctx, GLuint program, GLenum shadertype, GLuint index, GLsizei bufSize,
    ...
    void (*shader_binary)(GLMContext ctx, GLsizei count, const GLuint *shaders, GLenum binaryFormat, const void *binary,
                          GLsizei length);
    void (*get_shader_precision_format)(GLMContext ctx, GLenum shadertype, GLenum precisiontype, GLint *range,
                                        GLint *precision);
    void (*depth_rangef)(GLMContext ctx, GLfloat n, GLfloat f);
    void (*clear_depthf)(GLMContext ctx, GLfloat d);
    void (*get_program_binary)(GLMContext ctx, GLuint program, GLsizei bufSize, GLsizei *length, GLenum *binaryFormat,
                               void *binary);
    ...
    void (*program_uniform4f)(GLMContext ctx, GLuint program, GLint location, GLfloat v0, GLfloat v1, GLfloat v2,
                              GLfloat v3);
    void (*program_uniform4fv)(GLMContext ctx, GLuint program, GLint location, GLsizei count, const GLfloat *value);
    void (*program_uniform4d)(GLMContext ctx, GLuint program, GLint location, GLdouble v0, GLdouble v1, GLdouble v2,
                              GLdouble v3);
    void (*program_uniform4dv)(GLMContext ctx, GLuint program, GLint location, GLsizei count, const GLdouble *value);
    void (*program_uniform4ui)(GLMContext ctx, GLuint program, GLint location, GLuint v0, GLuint v1, GLuint v2,
                               GLuint v3);
    void (*program_uniform4uiv)(GLMContext ctx, GLuint program, GLint location, GLsizei count, const GLuint *value);
    void (*program_uniform_matrix2fv)(GLMContext ctx, GLuint program, GLint location, GLsizei count,
                                      GLboolean transpose, const GLfloat *value);
    void (*program_uniform_matrix3fv)(GLMContext ctx, GLuint program, GLint location, GLsizei count,
                                      GLboolean transpose, const GLfloat *value);
    void (*program_uniform_matrix4fv)(GLMContext ctx, GLuint program, GLint location, GLsizei count,
                                      GLboolean transpose, const GLfloat *value);
    void (*program_uniform_matrix2dv)(GLMContext ctx, GLuint program, GLint location, GLsizei count,
                                      GLboolean transpose, const GLdouble *value);
    void (*program_uniform_matrix3dv)(GLMContext ctx, GLuint program, GLint location, GLsizei count,
                                      GLboolean transpose, const GLdouble *value);
    void (*program_uniform_matrix4dv)(GLMContext ctx, GLuint program, GLint location, GLsizei count,
                                      GLboolean transpose, const GLdouble *value);
    void (*program_uniform_matrix2x3fv)(GLMContext ctx, GLuint program, GLint location, GLsizei count,
                                        GLboolean transpose, const GLfloat *value);
    void (*program_uniform_matrix3x2fv)(GLMContext ctx, GLuint program, GLint location, GLsizei count,
                                        GLboolean transpose, const GLfloat *value);
    void (*program_uniform_matrix2x4fv)(GLMContext ctx, GLuint program, GLint location, GLsizei count,
                                        GLboolean transpose, const GLfloat *value);
    void (*program_uniform_matrix4x2fv)(GLMContext ctx, GLuint program, GLint location, GLsizei count,
                                        GLboolean transpose, const GLfloat *value);
    void (*program_uniform_matrix3x4fv)(GLMContext ctx, GLuint program, GLint location, GLsizei count,
                                        GLboolean transpose, const GLfloat *value);
    void (*program_uniform_matrix4x3fv)(GLMContext ctx, GLuint program, GLint location, GLsizei count,
                                        GLboolean transpose, const GLfloat *value);
    void (*program_uniform_matrix2x3dv)(GLMContext ctx, GLuint program, GLint location, GLsizei count,
                                        GLboolean transpose, const GLdouble *value);
    void (*program_uniform_matrix3x2dv)(GLMContext ctx, GLuint program, GLint location, GLsizei count,
                                        GLboolean transpose, const GLdouble *value);
    void (*program_uniform_matrix2x4dv)(GLMContext ctx, GLuint program, GLint location, GLsizei count,
                                        GLboolean transpose, const GLdouble *value);
    void (*program_uniform_matrix4x2dv)(GLMContext ctx, GLuint program, GLint location, GLsizei count,
                                        GLboolean transpose, const GLdouble *value);
    void (*program_uniform_matrix3x4dv)(GLMContext ctx, GLuint program, GLint location, GLsizei count,
                                        GLboolean transpose, const GLdouble *value);
    void (*program_uniform_matrix4x3dv)(GLMContext ctx, GLuint program, GLint location, GLsizei count,
                                        GLboolean transpose, const GLdouble *value);
    void (*validate_program_pipeline)(GLMContext ctx, GLuint pipeline);
    void (*get_program_pipeline_info_log)(GLMContext ctx, GLuint pipeline, GLsizei bufSize, GLsizei *length,
                                          GLchar *infoLog);
    ...
    void (*vertex_attrib_l_pointer)(GLMContext ctx, GLuint index, GLint size, GLenum type, GLsizei stride,
                                    const void *pointer);
    ...
    void (*draw_arrays_instanced_base_instance)(GLMContext ctx, GLenum mode, GLint first, GLsizei count,
                                                GLsizei instancecount, GLuint baseinstance);
    void (*draw_elements_instanced_base_instance)(GLMContext ctx, GLenum mode, GLsizei count, GLenum type,
                                                  const void *indices, GLsizei instancecount, GLuint baseinstance);
    void (*draw_elements_instanced_base_vertex_base_instance)(GLMContext ctx, GLenum mode, GLsizei count, GLenum type,
                                                              const void *indices, GLsizei instancecount,
                                                              GLint basevertex, GLuint baseinstance);
    void (*get_internalformativ)(GLMContext ctx, GLenum target, GLenum internalformat, GLenum pname, GLsizei count,
                                 GLint *params);
    void (*get_active_atomic_counter_bufferiv)(GLMContext ctx, GLuint program, GLuint bufferIndex, GLenum pname,
                                               GLint *params);
    void (*bind_image_texture)(GLMContext ctx, GLuint unit, GLuint texture, GLint level, GLboolean layered, GLint layer,
    ...
    void (*tex_storage2D)(GLMContext ctx, GLenum target, GLsizei levels, GLenum internalformat, GLsizei width,
                          GLsizei height);
    void (*tex_storage3D)(GLMContext ctx, GLenum target, GLsizei levels, GLenum internalformat, GLsizei width,
                          GLsizei height, GLsizei depth);
    void (*draw_transform_feedback_instanced)(GLMContext ctx, GLenum mode, GLuint id, GLsizei instancecount);
    void (*draw_transform_feedback_stream_instanced)(GLMContext ctx, GLenum mode, GLuint id, GLuint stream,
                                                     GLsizei instancecount);
    void (*clear_buffer_data)(GLMContext ctx, GLenum target, GLenum internalformat, GLenum format, GLenum type,
                              const void *data);
    void (*clear_buffer_sub_data)(GLMContext ctx, GLenum target, GLenum internalformat, GLintptr offset,
    ...
    void (*copy_image_sub_data)(GLMContext ctx, GLuint srcName, GLenum srcTarget, GLint srcLevel, GLint srcX,
    ...
    void (*get_internalformati64v)(GLMContext ctx, GLenum target, GLenum internalformat, GLenum pname, GLsizei count,
                                   GLint64 *params);
    void (*invalidate_tex_sub_image)(GLMContext ctx, GLuint texture, GLint level, GLint xoffset, GLint yoffset,
    ...
    void (*invalidate_sub_framebuffer)(GLMContext ctx, GLenum target, GLsizei numAttachments, const GLenum *attachments,
                                       GLint x, GLint y, GLsizei width, GLsizei height);
    void (*multi_draw_arrays_indirect)(GLMContext ctx, GLenum mode, const void *indirect, GLsizei drawcount,
                                       GLsizei stride);
    void (*multi_draw_elements_indirect)(GLMContext ctx, GLenum mode, GLenum type, const void *indirect,
                                         GLsizei drawcount, GLsizei stride);
    void (*get_program_interfaceiv)(GLMContext ctx, GLuint program, GLenum programInterface, GLenum pname,
                                    GLint *params);
    GLuint (*get_program_resource_index)(GLMContext ctx, GLuint program, GLenum programInterface, const GLchar *name);
    void (*get_program_resource_name)(GLMContext ctx, GLuint program, GLenum programInterface, GLuint index,
                                      GLsizei bufSize, GLsizei *length, GLchar *name);
    void (*get_program_resourceiv)(GLMContext ctx, GLuint program, GLenum programInterface, GLuint index,
    ...
    GLint (*get_program_resource_location_index)(GLMContext ctx, GLuint program, GLenum programInterface,
                                                 const GLchar *name);
    void (*shader_storage_block_binding)(GLMContext ctx, GLuint program, GLuint storageBlockIndex,
                                         GLuint storageBlockBinding);
    void (*tex_buffer_range)(GLMContext ctx, GLenum target, GLenum internalformat, GLuint buffer, GLintptr offset,
                             GLsizeiptr size);
    void (*tex_storage2_d_multisample)(GLMContext ctx, GLenum target, GLsizei samples, GLenum internalformat,
                                       GLsizei width, GLsizei height, GLboolean fixedsamplelocations);
    void (*tex_storage3_d_multisample)(GLMContext ctx, GLenum target, GLsizei samples, GLenum internalformat,
                                       GLsizei width, GLsizei height, GLsizei depth, GLboolean fixedsamplelocations);
    void (*texture_view)(GLMContext ctx, GLuint texture, GLenum target, GLuint origtexture, GLenum internalformat,
    ...
    void (*vertex_attrib_format)(GLMContext ctx, GLuint attribindex, GLint size, GLenum type, GLboolean normalized,
    ...
    void (*debug_message_control)(GLMContext ctx, GLenum source, GLenum type, GLenum severity, GLsizei count,
                                  const GLuint *ids, GLboolean enabled);
    void (*debug_message_insert)(GLMContext ctx, GLenum source, GLenum type, GLuint id, GLenum severity, GLsizei length,
                                 const GLchar *buf);
    void (*debug_message_callback)(GLMContext ctx, GLDEBUGPROC callback, const void *userParam);
    GLuint (*get_debug_message_log)(GLMContext ctx, GLuint count, GLsizei bufSize, GLenum *sources, GLenum *types,
    ...
    void (*get_object_label)(GLMContext ctx, GLenum identifier, GLuint name, GLsizei bufSize, GLsizei *length,
                             GLchar *label);
    ...
    void (*clear_tex_sub_image)(GLMContext ctx, GLuint texture, GLint level, GLint xoffset, GLint yoffset,
    ...
    void (*bind_buffers_range)(GLMContext ctx, GLenum target, GLuint first, GLsizei count, const GLuint *buffers,
    ...
    void (*bind_vertex_buffers)(GLMContext ctx, GLuint first, GLsizei count, const GLuint *buffers,
    ...
    void (*transform_feedback_buffer_range)(GLMContext ctx, GLuint xfb, GLuint index, GLuint buffer, GLintptr offset,
                                            GLsizeiptr size);
    ...
    void (*copy_named_buffer_sub_data)(GLMContext ctx, GLuint readBuffer, GLuint writeBuffer, GLintptr readOffset,
                                       GLintptr writeOffset, GLsizeiptr size);
    void (*clear_named_buffer_data)(GLMContext ctx, GLuint buffer, GLenum internalformat, GLenum format, GLenum type,
                                    const void *data);
    void (*clear_named_buffer_sub_data)(GLMContext ctx, GLuint buffer, GLenum internalformat, GLintptr offset,
                                        GLsizeiptr size, GLenum format, GLenum type, const void *data);
    void *(*map_named_buffer)(GLMContext ctx, GLuint buffer, GLenum access);
    void *(*map_named_buffer_range)(GLMContext ctx, GLuint buffer, GLintptr offset, GLsizeiptr length,
                                    GLbitfield access);
    ...
    void (*named_framebuffer_renderbuffer)(GLMContext ctx, GLuint framebuffer, GLenum attachment,
                                           GLenum renderbuffertarget, GLuint renderbuffer);
    void (*named_framebuffer_parameteri)(GLMContext ctx, GLuint framebuffer, GLenum pname, GLint param);
    void (*named_framebuffer_texture)(GLMContext ctx, GLuint framebuffer, GLenum attachment, GLuint texture,
                                      GLint level);
    void (*named_framebuffer_texture_layer)(GLMContext ctx, GLuint framebuffer, GLenum attachment, GLuint texture,
    ...
    void (*invalidate_named_framebuffer_data)(GLMContext ctx, GLuint framebuffer, GLsizei numAttachments,
                                              const GLenum *attachments);
    void (*invalidate_named_framebuffer_sub_data)(GLMContext ctx, GLuint framebuffer, GLsizei numAttachments,
                                                  const GLenum *attachments, GLint x, GLint y, GLsizei width,
                                                  GLsizei height);
    void (*clear_named_framebufferiv)(GLMContext ctx, GLuint framebuffer, GLenum buffer, GLint drawbuffer,
                                      const GLint *value);
    void (*clear_named_framebufferuiv)(GLMContext ctx, GLuint framebuffer, GLenum buffer, GLint drawbuffer,
                                       const GLuint *value);
    void (*clear_named_framebufferfv)(GLMContext ctx, GLuint framebuffer, GLenum buffer, GLint drawbuffer,
                                      const GLfloat *value);
    void (*clear_named_framebufferfi)(GLMContext ctx, GLuint framebuffer, GLenum buffer, GLint drawbuffer,
                                      GLfloat depth, GLint stencil);
    void (*blit_named_framebuffer)(GLMContext ctx, GLuint readFramebuffer, GLuint drawFramebuffer, GLint srcX0,
    ...
    void (*get_named_framebuffer_attachment_parameteriv)(GLMContext ctx, GLuint framebuffer, GLenum attachment,
                                                         GLenum pname, GLint *params);
    void (*create_renderbuffers)(GLMContext ctx, GLsizei n, GLuint *renderbuffers);
    void (*named_renderbuffer_storage)(GLMContext ctx, GLuint renderbuffer, GLenum internalformat, GLsizei width,
                                       GLsizei height);
    void (*named_renderbuffer_storage_multisample)(GLMContext ctx, GLuint renderbuffer, GLsizei samples,
    ...
    void (*texture_buffer_range)(GLMContext ctx, GLuint texture, GLenum internalformat, GLuint buffer, GLintptr offset,
                                 GLsizeiptr size);
    void (*texture_storage1D)(GLMContext ctx, GLuint texture, GLsizei levels, GLenum internalformat, GLsizei width);
    void (*texture_storage2D)(GLMContext ctx, GLuint texture, GLsizei levels, GLenum internalformat, GLsizei width,
                              GLsizei height);
    void (*texture_storage3D)(GLMContext ctx, GLuint texture, GLsizei levels, GLenum internalformat, GLsizei width,
                              GLsizei height, GLsizei depth);
    void (*texture_storage2_d_multisample)(GLMContext ctx, GLuint texture, GLsizei samples, GLenum internalformat,
                                           GLsizei width, GLsizei height, GLboolean fixedsamplelocations);
    void (*texture_storage3_d_multisample)(GLMContext ctx, GLuint texture, GLsizei samples, GLenum internalformat,
                                           GLsizei width, GLsizei height, GLsizei depth,
                                           GLboolean fixedsamplelocations);
    void (*texture_sub_image1D)(GLMContext ctx, GLuint texture, GLint level, GLint xoffset, GLsizei width,
                                GLenum format, GLenum type, const void *pixels);
    void (*texture_sub_image2D)(GLMContext ctx, GLuint texture, GLint level, GLint xoffset, GLint yoffset,
                                GLsizei width, GLsizei height, GLenum format, GLenum type, const void *pixels);
    void (*texture_sub_image3D)(GLMContext ctx, GLuint texture, GLint level, GLint xoffset, GLint yoffset,
                                GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type,
                                const void *pixels);
    void (*compressed_texture_sub_image1D)(GLMContext ctx, GLuint texture, GLint level, GLint xoffset, GLsizei width,
                                           GLenum format, GLsizei imageSize, const void *data);
    void (*compressed_texture_sub_image2D)(GLMContext ctx, GLuint texture, GLint level, GLint xoffset, GLint yoffset,
                                           GLsizei width, GLsizei height, GLenum format, GLsizei imageSize,
                                           const void *data);
    void (*compressed_texture_sub_image3D)(GLMContext ctx, GLuint texture, GLint level, GLint xoffset, GLint yoffset,
                                           GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format,
                                           GLsizei imageSize, const void *data);
    void (*copy_texture_sub_image1D)(GLMContext ctx, GLuint texture, GLint level, GLint xoffset, GLint x, GLint y,
                                     GLsizei width);
    void (*copy_texture_sub_image2D)(GLMContext ctx, GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint x,
                                     GLint y, GLsizei width, GLsizei height);
    void (*copy_texture_sub_image3D)(GLMContext ctx, GLuint texture, GLint level, GLint xoffset, GLint yoffset,
                                     GLint zoffset, GLint x, GLint y, GLsizei width, GLsizei height);
    ...
    void (*get_texture_image)(GLMContext ctx, GLuint texture, GLint level, GLenum format, GLenum type, GLsizei bufSize,
                              void *pixels);
    ...
    void (*vertex_array_vertex_buffer)(GLMContext ctx, GLuint vaobj, GLuint bindingindex, GLuint buffer,
                                       GLintptr offset, GLsizei stride);
    void (*vertex_array_vertex_buffers)(GLMContext ctx, GLuint vaobj, GLuint first, GLsizei count,
    ...
    void (*vertex_array_attrib_format)(GLMContext ctx, GLuint vaobj, GLuint attribindex, GLint size, GLenum type,
                                       GLboolean normalized, GLuint relativeoffset);
    void (*vertex_array_attrib_i_format)(GLMContext ctx, GLuint vaobj, GLuint attribindex, GLint size, GLenum type,
                                         GLuint relativeoffset);
    void (*vertex_array_attrib_l_format)(GLMContext ctx, GLuint vaobj, GLuint attribindex, GLint size, GLenum type,
                                         GLuint relativeoffset);
    ...
    void (*get_texture_sub_image)(GLMContext ctx, GLuint texture, GLint level, GLint xoffset, GLint yoffset,
                                  GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format,
                                  GLenum type, GLsizei bufSize, void *pixels);
    void (*get_compressed_texture_sub_image)(GLMContext ctx, GLuint texture, GLint level, GLint xoffset, GLint yoffset,
                                             GLint zoffset, GLsizei width, GLsizei height, GLsizei depth,
    ...
    void (*getn_tex_image)(GLMContext ctx, GLenum target, GLint level, GLenum format, GLenum type, GLsizei bufSize,
                           void *pixels);
    ...
    void (*readn_pixels)(GLMContext ctx, GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type,
    ...
    void (*getn_convolution_filter)(GLMContext ctx, GLenum target, GLenum format, GLenum type, GLsizei bufSize,
                                    void *image);
    void (*getn_separable_filter)(GLMContext ctx, GLenum target, GLenum format, GLenum type, GLsizei rowBufSize,
                                  void *row, GLsizei columnBufSize, void *column, void *span);
    void (*getn_histogram)(GLMContext ctx, GLenum target, GLboolean reset, GLenum format, GLenum type, GLsizei bufSize,
                           void *values);
    void (*getn_minmax)(GLMContext ctx, GLenum target, GLboolean reset, GLenum format, GLenum type, GLsizei bufSize,
                        void *values);
    void (*texture_barrier)(GLMContext ctx);
    void (*specialize_shader)(GLMContext ctx, GLuint shader, const GLchar *pEntryPoint,
                              GLuint numSpecializationConstants, const GLuint *pConstantIndex,
                              const GLuint *pConstantValue);
    void (*multi_draw_arrays_indirect_count)(GLMContext ctx, GLenum mode, const void *indirect, GLintptr drawcount,
                                             GLsizei maxdrawcount, GLsizei stride);
    void (*multi_draw_elements_indirect_count)(GLMContext ctx, GLenum mode, GLenum type, const void *indirect,
