...
void getMacOSDefaults(GLMContext glm_ctx)
{
    ...
    CGLError (*CGLChoosePixelFormat)(const CGLPixelFormatAttribute *attribs,
                                     CGLPixelFormatObj OPENGL_NULLABLE *OPENGL_NONNULL pix, GLint *npix);
    CGLError (*CGLDestroyPixelFormat)(CGLPixelFormatObj pix);
    CGLError (*CGLCreateContext)(CGLPixelFormatObj pix, CGLContextObj OPENGL_NULLABLE share,
    ...
    CGLPixelFormatAttribute attributes[4] = {kCGLPFAAccelerated,   // no software rendering
    ...
    glGetIntegerv(GL_MAX_COMBINED_VERTEX_UNIFORM_COMPONENTS,
                  &glm_ctx->state.var.max_combined_vertex_uniform_components);
    glGetIntegerv(GL_MAX_COMBINED_GEOMETRY_UNIFORM_COMPONENTS,
                  &glm_ctx->state.var.max_combined_geometry_uniform_components);
    glGetIntegerv(GL_MAX_COMBINED_FRAGMENT_UNIFORM_COMPONENTS,
                  &glm_ctx->state.var.max_combined_fragment_uniform_components);
    ...
    glGetIntegerv(GL_MAX_COMBINED_COMPUTE_UNIFORM_COMPONENTS,
                  &glm_ctx->state.var.max_combined_compute_uniform_components);
    ...
    glGetIntegerv(GL_MAX_TESS_CONTROL_SHADER_STORAGE_BLOCKS,
                  &glm_ctx->state.var.max_tess_control_shader_storage_blocks);
    glGetIntegerv(GL_MAX_TESS_EVALUATION_SHADER_STORAGE_BLOCKS,
                  &glm_ctx->state.var.max_tess_evaluation_shader_storage_blocks);
