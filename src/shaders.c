...
const char *getShaderTypeStr(GLuint type) {
  static const char *types[] = {"VERTEX_SHADER",          "FRAGMENT_SHADER",
                                "GEOMETRY_SHADER",        "TESS_CONTROL_SHADER",
                                "TESS_EVALUATION_SHADER", "COMPUTE_SHADER",
                                "MAX_SHADER_TYPES",       NULL};
...
void initGLSLInput(GLMContext ctx, GLuint type, const char *src,
...
Shader *newShader(GLMContext ctx, GLenum type, GLuint shader) {
  ...
  snprintf(shader_type_name, sizeof(shader_type_name), "%s_%d",
           getShaderTypeStr(ptr->glm_type), shader);
...
void mglShaderSource(GLMContext ctx, GLuint shader, GLsizei count,
...
void mglGetShaderiv(GLMContext ctx, GLuint shader, GLenum pname,
                    GLint *params) {
  Shader *ptr;
...
void mglGetShaderInfoLog(GLMContext ctx, GLuint shader, GLsizei bufSize,
...
void mglGetShaderSource(GLMContext ctx, GLuint shader, GLsizei bufSize,
